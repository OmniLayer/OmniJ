...
class AddressBalanceEntriesDeserializerSpec extends BaseOmniClientMapperSpec {
    ...
    def "fragment #fragment scans to #expectedResult"() {
        ...
        '[{"address":"moneyqMan7uh8FqdCA2BV5yZ8qVrc9ikLP","balance":"1.0","reserved":"0.0"}]'   | [(moneyMan): new BalanceEntry(1.0,0.0)]
        '[{"address":"moneyqMan7uh8FqdCA2BV5yZ8qVrc9ikLP","balance":"0.0","reserved":"1.0"}]'   | [(moneyMan): new BalanceEntry(0.0,1.0)]
        '[{"address":"moneyqMan7uh8FqdCA2BV5yZ8qVrc9ikLP","balance":"1.0","reserved":"1.0"}]'   | [(moneyMan): new BalanceEntry(1.0,1.0)]
    }
