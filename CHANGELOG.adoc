...
* Omni Chest consensus tool has hardcoded divisible/indivisble OmniValue selection that needs work
...
** BalanceEntry replaces ConsensEntry
** BalanceEntry using OmniValue rather than BigDecimail
* Use Jackson JSON mappping more effectively
